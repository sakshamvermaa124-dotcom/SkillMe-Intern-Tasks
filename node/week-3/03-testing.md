---
title: "Week 3 Task 3: Testing & Code Review for Authentication (JWT)"
difficulty: "medium"
labels: ["week-3", "medium", "node"]
---
## Objective
Validate your implementation of **Authentication (JWT)** and prepare your code for review.
